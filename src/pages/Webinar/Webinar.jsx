      ...
      <div className="webinar-container">
        ...
        <div class="webinar-text">
          <p>
            ...
            others at a small fee.
          </p>
        </div>
      </div>

      <div className="webinar-container-2">
        <div class="webinar-text">
          <p>
            Our three successful webinars have been with the renowned speakers
            such as Dr. Samir Parikh, director of department of mental health
            and behavioural sciences of fortis healthcare which was help free of
            all cost, paid webinars with Neelam Mishra and national level
            webinars guided by Divya Dureja.
          </p>
        </div>
        <div class="webinar-image">
          <img className="webinar-actual-image" src={WebinarImage} />
        </div>
      </div>
      <Footer />
    </div>
