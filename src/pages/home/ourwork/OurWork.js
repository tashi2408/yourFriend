      ...
      <div className="ourwork-section">
        <div className="left-container ">
          ...
          <p className="primary-para color-w">
            ...
            people using social media to educate themselves and take subsequent
            action on-ground, YMH has put a lot of effort into connecting with
            people on a national as well as international level. We have
            successfully organized many on-ground and online campaigns focused
            on a variety of issues to encourage conversations and suggest
      ...
      <div className="ourwork-section">
        <div className="left-container ">
          ...
          <p className="primary-para color-w">
            ...
            others at a small fee. Our three successful webinars have been with
            the renowned speakers such as Dr. Samir Parikh, director of
